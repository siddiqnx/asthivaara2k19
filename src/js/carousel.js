...
const carousel = document.querySelector('.event-card.expanded .carousel');
...
eventCards.forEach((card) => {
  card.addEventListener('click', () => {
    if(!card.classList.contains('expanded')) {
      ...
      let items = document.querySelectorAll(".event-card.expanded .carousel__photo");
      ...
      function resetClasses() {
        ...
        items[0].className = itemClassName + ' initial active';
  ...
  // let carouselPhotos = carousel.querySelectorAll('.carousel-photo');
  // let carouselCount = carouselPhotos.length;
